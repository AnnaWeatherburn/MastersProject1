...
int main(int argc,char** argv)
{
  ...
  if ( argc > 7 ) {
    ...
    //struct arg_dbl  *plasticthickness	= arg_dbl("gG", "gelthick","<n>","\t\t\tgel thickness in mm");
    //void* argtable[] = {plasticthickness};
    //
    // plasticthickness->dval[0] = 20.;
    // gplasticThickness = plasticthickness->dval[0];
  }
